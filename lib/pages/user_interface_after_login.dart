        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context); // Close the drawer
                Navigator.push(         // Navigate to the Road Signs screen
                  context,
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context); // Close the drawer
                Navigator.push(         // Navigate to the Driving Tips screen
                  context,
                  MaterialPageRoute(builder: (context) => DrivingTipsScreen()),
                );
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context); // Close the drawer
                Navigator.push(         // Navigate to the Towing Services screen
                  context,
                  MaterialPageRoute(builder: (context) => TowingServicesPage()),
                );
              },
            ),
          ],
