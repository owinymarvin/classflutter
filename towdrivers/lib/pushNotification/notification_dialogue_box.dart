...
class _NotificationDialogueBoxState extends State<NotificationDialogueBox> {
  ...
  Widget build(BuildContext context) {
    bool darkthem=MediaQuery.of(context).platformBrightness==Brightness.dark;
    return Dialog(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Image.asset(
              onlineDriverData.car_type=="Flatbed"?"assets/images/tow2.png"
              :onlineDriverData.car_type=="Hook&Chain"?"assets/images/tow2.png"
            ...
            child: Column(children: [
              Row(
                children: [
                  Image.asset("assets/images/tow2.png",
                  width: 30,
                  height: 30,),
                  SizedBox(width: 10,),
                  Expanded(child: Container(
                    child: Text(widget.userRideRequestDetails!.originAddress!,
                    style: TextStyle(fontSize: 16, color: darkthem?Colors.amber.shade400:Colors.greenAccent,),),
                  ),
                  ),
                ],
              ),
              ...
              Row(
                children: [
                  Image.asset("assets/images/desticon1.png",
                  width: 30,
                  height: 30,
                  ),
